...
export default function PromptScore({ scores, totalScore }: PromptScoreProps) {
  const categories = [
    ...
    { key: 'specificity', label: '구체성', value: scores.specificity, color: '#6DB6C9' },
    { key: 'format', label: '형식 준수', value: scores.format, color: '#5B9BD5' },
    { key: 'completeness', label: '안정성', value: scores.completeness, color: '#9DBFC9' },
  ];
